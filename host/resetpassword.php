            ...
            <div class="card-group">
                <div class="card p-4">
                    <div class="card-body">
                        ...
                        <hr>
                                                <form class="form-horizontal" method="POST" action="/*co-shared*/">
                            <input type="hidden" name="_token" value="bfxv0wQRZT4srelyZV1VZ7UmOvs3sLYtGgynCV02">
                            <div class="form-group">
                                <label for="email" class="control-label">Email</label>
                                                                <input type="email" id="email" name="email" class="form-control" value="" placeholder="Youremail@domain.com" autofocus>
                            </div>
                            <br>
                            <button type="submit" class="btn btn-primary btn-block px-4">Send Password Reset Link</button>
                            <p class="text-center"><a href="host_login.php" class="btn btn-link px-0">Back to Login</a></p>
                        </form>
                    </div>
                </div>
            </div>
