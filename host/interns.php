...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
	...
	<div class="card-header">
		<h4><strong>Portal User Interns at Madaraka Primary School </strong>
		</h4>
	</div>
	
	<div class="card-body">
				<table class="table table-responsive-sm" id="tbl-interns">
			<thead>
				<tr>
					<th>#</th>
					<th>Name</th>
			...
			<tbody>
					...
					<td>1</td>
					<td>Spider Man</td>
					<td>Bachelor of Business Information Technology (BBIT)</td>
					<td>Faculty of Information Technology</td>
					<td><a href="view.php"><span class="fa fa-file"></span> View</a></td>
